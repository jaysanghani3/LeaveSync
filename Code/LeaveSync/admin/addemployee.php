...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,salary,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:salary,:status)";
    ...
    // echo "<script>window.location.href='employee_details.php?id=$lastInsertId';</script>";
} else {
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="salary" name="salary" type="text" autocomplete="off" placeholder="450000" required>
                                                        </div>
