...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        // $sql = "INSERT INTO tbldepartments(DepartmentName,DepartmentCode,DepartmentShortName,AddedBy) VALUES(:deptname,:deptcode,:deptshortname,:addedby)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':deptname', $deptname, PDO::PARAM_STR);
        $query->bindParam(':deptcode', $deptcode, PDO::PARAM_STR);
        // $query->bindParam(':addedby', $addedby, PDO::PARAM_STR);
                            ...
                            <div class="row">
                                <form class="col s12" name="chngpwd" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="input-field col s12">
                                            <input id="addedby" type="text" name="addedby" class="validate"
                                                autocomplete="off" required>
