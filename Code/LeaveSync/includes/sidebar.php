<aside id="slide-out" class="side-nav white fixed">
    <div class="side-nav-wrapper">
        ...
        <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
            ...
            <!-- <li class="no-padding"><a class="waves-effect waves-grey" href="salaryslip.php"?id=<?php $eid ?>><i class="material-icons">receipt</i>Salary Slip</a></li> -->
            <li class="no-padding"><a class="waves-effect waves-grey" href="salaryslip.php?id=<?php echo $eid; ?>"><i class="material-icons">receipt</i>Salary Slip</a></li>
